...
const LiveMetrics = ({ enabled, focus, calm, brainState }) => {
    ...
    return (
        <div className="fixed top-[calc(4.5rem+env(safe-area-inset-top))] right-2 sm:right-4 z-30 flex flex-col gap-3 pointer-events-none animate-in slide-in-from-right-10 fade-in duration-1000">
